...
export default function ReferentesPage(){
    ...
    return(
        <div className={styles.page}>
            ...
            <Button title={'Añadir'} callback={wsRequest(handleRef,handleRsp,handleError,{'tokenUsuario' : user['TokenGuid'] , 'json' : {'nombre' : name , 'email' : email , 'telefono' : phone}},'ReferenteSave')} isDisable={isDisable} />
        </div>
    )
}