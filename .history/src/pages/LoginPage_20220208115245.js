...
export default function LoginPage(){ 
    ...
    const triggerRequest = () => {
            ...
            '<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">'+
                '<soap:Body>'+
                    '<tokenUsuarioGet xmlns="http://HomologacionWebsiteServices.activia.com.ar/">'+
                        '<passportHash>4f5c9edb-f745-4ad3-b6a5-8ac8ae98a1b2</passportHash>'+
                    '</tokenUsuarioGet>'+
            '</soap:Body>'+
        '</soap:Envelope>';
        ...
        xmlhttp.setRequestHeader('SOAPAction', 'http://172.16.1.6:8088/HomologacionWebsiteServices.asmx?op=tokenUsuarioGet');
