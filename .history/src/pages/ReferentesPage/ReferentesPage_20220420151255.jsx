...
export default function ReferentesPage() {
    ...
    return ( <
        ...
        callback = { setReferenteName }
        /> <
        Input placeholder = { 'Apellido' }
        callback = { setReferenteLastName }
        /> <
        Input placeholder = { 'Email' }
        callback = { setReferenteEmail }
        /> <
        Input placeholder = { 'Phone' }
        callback = { setReferentePhone }
        /> <
        Button title = { 'Añadir' }
        callback = {
            () => wsRequest(handleRef, handleRsp, handleError, { 'tokenUsuario': user['TokenGuid'], 'json': JSON.stringify(referente) }, 'ReferenteSave') }
        isDisable = { isDisable }
